...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            __برودكاست عادي__ : ${prefix}bc
            __دعوة البوت لسيرفرك__ : ${prefix}invite
            __معلومات عن السيرفر__ : ${prefix}server
            __برودكاست للأونلاين فقط__ : ${prefix}bco
            __يعرض لك عدد المتبندين من سيرفرك__ : ${prefix}banned
            رابط سيرفر الدعم الفني: https://discord.gg/N85Cbma
            **`);
